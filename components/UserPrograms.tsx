      ...
      <div className="container mx-auto max-w-6xl px-4">
        ...
        <div className="bg-card/90 backdrop-blur-sm border border-border rounded-lg overflow-hidden mb-16">
          ...
          <div className="p-4 text-center">
            ...
            {/* STATS */}
            <div className="flex items-center justify-between lg:justify-evenly mt-10 font-mono">
              <div className="flex flex-col items-center ">
                <p className="text-lg lg:text-3xl text-primary">500+</p>
                <p className="text-[12px] lg:text-sm text-muted-foreground uppercase tracking-wide mt-1">
                  PROGRAMS
                </p>
              </div>
              <div className="w-px h-12 bg-border"></div>
              <div className="flex flex-col items-center">
                <p className="text-lg lg:text-3xl text-primary">3min</p>
                <p className="text-[12px] lg:text-sm text-muted-foreground uppercase tracking-wide mt-1">
                  CREATION TIME
                </p>
              </div>
              <div className="w-px h-12 bg-border"></div>
              <div className="flex flex-col items-center">
                <p className="text-lg lg:text-3xl text-primary">100%</p>
                <p className="text-[12px] lg:text-sm text-muted-foreground uppercase tracking-wide mt-1">
                  PERSONALIZED
                </p>
              </div>
